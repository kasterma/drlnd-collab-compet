...
class NNAnalysis:
    ...
    def __init__(self, run_id):
        ...
        for episode in self.episode_list:
            ...
            for k, v in agent.actor_2_local.named_parameters():
                self.data["actor_2"][k][episode] = v.detach().numpy()
            for k, v in agent.critic_local.named_parameters():
                self.data["critic"][k][episode] = v.detach().numpy()
